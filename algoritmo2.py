...
# reported EPS.  
    ...
    combined_factor = (
        0.15*value_winsorized.zscore() +
        0.15*quality_winsorized.zscore() +
        0.1*sentiment_score_winsorized.zscore()+
        0.2*positive_sentiment_pct_winsorized.zscore() +
        0.2*positive_sentiment_pctt_winsorized.zscore() +
        0.2*positive_sentiment_pcttt_winsorized.zscore()
    )
