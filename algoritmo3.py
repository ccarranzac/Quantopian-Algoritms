...
from quantopian.pipeline.data.psychsignal import stocktwits
from quantopian.pipeline.data.psychsignal import twitter_noretweets
...
# reported EPS.  
    ...
    positive_sentiment_pctt = (
        stocktwits.bull_scored_messages.latest
        / stocktwits.total_scanned_messages.latest
)
    positive_sentiment_pcttt = (
        twitter_noretweets.bull_scored_messages.latest
        / twitter_noretweets.total_scanned_messages.latest
)
    ...
    positive_sentiment_pcttt_winsorized=positive_sentiment_pcttt.winsorize(min_percentile=                                                          0.05,max_percentile=0.95)
    combined_factor = (
        0.25*value_winsorized.zscore() +
        0.25*quality_winsorized.zscore() +
        0.25*sentiment_score_winsorized.zscore()+
        0.15*positive_sentiment_pct_winsorized.zscore() +
        0.05*positive_sentiment_pctt_winsorized.zscore() +
        0.05*positive_sentiment_pcttt_winsorized.zscore()
    )
    ...
    pipe = Pipeline(
        columns={
            ...
            'positive_sentiment_pct_winsorized': positive_sentiment_pct_winsorized,
            'positive_sentiment_pctt_winsorized': positive_sentiment_pctt_winsorized,
            'positive_sentiment_pcttt_winsorized': positive_sentiment_pcttt_winsorized,
        },
