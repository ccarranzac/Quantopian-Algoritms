...
def make_pipeline():
    ...
    combined_factor = (
        0.3*value_winsorized.zscore() +
        0.3*quality_winsorized.zscore() +
        0.3*sentiment_score_winsorized.zscore()+
        0.03*positive_sentiment_pct_winsorized.zscore() +
        0.03*positive_sentiment_pctt_winsorized.zscore() +
        0.04*positive_sentiment_pcttt_winsorized.zscore()
    )
